...
SCRAPER_DEFAULT_NEEDLE_WIDTH = 2 # TODO: get actual width of needle
...
class Scraper(MotionController):
    ...
    def scrape(self, pos, width, crossover=SCRAPER_DEFAULT_CROSSOVER, speed=SCRAPER_DEFAULT_SCRAPE_SPEED, accel=SCRAPER_DEFAULT_SCRAPE_ACCEL):
        step_size = self.needle_width - crossover
